...
# 读入树文件
tree <- read.tree("data/hmptree.nwk")

# 读入ID注释信息：phylum, type and size
dat1 <- read.csv("data/tippoint_attr.csv")

# 读入ID注释信息：site和丰度
dat2 <- read.csv("data/ringheatmap_attr.csv")

# 第三个注释信息
dat3 <- read.csv("data/barplot_attr.csv")
